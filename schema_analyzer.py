...
class SchemaAnalyzer:
    ...
    def _initialize_subgraphs(self):
        self.logger.info("Setting up subgraphs...")
        self.subgraphs = {
            'pnl': SubgraphInfo(
                'PNL Subgraph',
        ...
        self.logger.info(f"Subgraphs initialized: {list(self.subgraphs.keys())}")
    ...
    def _validate_config(self):
        ...
        if not hasattr(self, 'subgraphs'):
            raise ValueError("Subgraphs not initialized")
        ...
        for subgraph_id, info in self.subgraphs.items():
            ...
            self.logger.info(f"Validated {subgraph_id} URL: {url_preview}")
